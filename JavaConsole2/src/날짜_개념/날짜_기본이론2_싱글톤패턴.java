...
class MySingleTonDAO {
	...
	// 3. instance변수에 접근할 수 있는 메서드를 생성한다.
	public static MySingleTonDAO getInstance() { return MySingleTonDAO.instance; }
}
